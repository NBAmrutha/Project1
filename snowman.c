...
void renderScene(void) {
	...
	glPushMatrix();
	glLoadIdentity();
	//renderBitmapString(30, 15, (void *)font, "CHAITRA & JEEVANA");
	renderBitmapString(30, 35, (void *)font, "Esc - Quit");
	glPopMatrix();
...
void pressKey(int key, int x, int y) {
	...
	//case GLUT_KEY_T:deltaMove = 1; break;
	}
...
void releaseKey(int key, int x, int y) {
	...
	case GLUT_KEY_DOWN: if (deltaMove < 0)
		deltaMove = 0;
		break;
 	//case GLUT_KEY_T: if(deltaMove > 0)
	        //deltaMove = 0;
	}
}
